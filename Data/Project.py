...
# Fill blank or missing 'Campaign_ID' with unique random values
Linkedindata["Campaign_ID"] = Linkedindata["Campaign_ID"].apply(lambda x: generate_unique_id() if pd.isna(x) or x == "" else x)
...
conn = mysql.connector.connect(
    host='localhost',
    database='social_media_project_new',
    user='root',
    password='6844'
)
...
cursor.close()
conn.close()
print("Audience table completed")
